...
[![Tests](https://img.shields.io/badge/security%20tests-542-green.svg)](#three-layers-of-agent-decision-security)
...
| **Total tests** | Pattern matching | YARA rules | Config checks | Model probes | **542 active tests** |
...
| Full Test Inventory (542 tests) | [docs/TEST-INVENTORY.md](docs/TEST-INVENTORY.md) |
