...
[![Tests](https://img.shields.io/badge/security%20tests-557-green.svg)](#three-layers-of-agent-decision-security)
...
| **Total tests** | Pattern matching | YARA rules | Config checks | Model probes | **557 active tests** |
...
| Full Test Inventory (557 tests) | [docs/TEST-INVENTORY.md](docs/TEST-INVENTORY.md) |
