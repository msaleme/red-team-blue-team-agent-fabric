...
[![Tests](https://img.shields.io/badge/security%20tests-541-green.svg)](#three-layers-of-agent-decision-security)
...
| **Total tests** | Pattern matching | YARA rules | Config checks | Model probes | **541 active tests** |
...
| Full Test Inventory (541 tests) | [docs/TEST-INVENTORY.md](docs/TEST-INVENTORY.md) |
