...
[![Tests](https://img.shields.io/badge/security%20tests-520-green.svg)](#three-layers-of-agent-decision-security)
...
520 executable security tests across 36 modules. MCP + A2A + L402 + x402 wire-protocol testing, plus UCP/ACP merchant-journey, AP2 mandate-chain and Fireblocks x402 hardening conformance across all four layers of the agentic-payments stack. Decision-layer attack scenarios. One `pip install` away.
...
| **Total tests** | Pattern matching | YARA rules | Config checks | Model probes | **520 active tests** |
...
| Full Test Inventory (520 tests) | [docs/TEST-INVENTORY.md](docs/TEST-INVENTORY.md) |
