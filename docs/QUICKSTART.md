...
**Available tools:** `scan_mcp_server` (quick 5-test scan), `full_security_audit` (541 tests), `aiuc1_readiness` (certification prep), `get_test_catalog` (list tests), `validate_attestation` (schema validation).
