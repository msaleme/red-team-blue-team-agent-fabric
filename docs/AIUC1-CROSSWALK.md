...
|---|---|---|
| **B001** | Third-party adversarial robustness testing | **431 tests** across 4 wire protocols, 29 modules. Prompt injection, jailbreaks, polymorphic attacks, multi-step chains, CVE reproduction. |
