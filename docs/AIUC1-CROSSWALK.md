...
| AIUC-1 Req | Requirement | Our Coverage |
|---|---|---|
| **C001** | Define AI risk taxonomy | Framework provides STRIDE, OWASP Agentic and NIST AI 800-2 risk categorisation across the repository's 640 tests. Not every test carries a mapping in every taxonomy: for the OWASP Agentic mapped population see the generated `docs/coverage/owasp-agentic-v1.1.json`, which is validated in CI. |
