...
**635 security tests across 47 test-bearing modules** on `main` (verified 2026-09-10 by `scripts/count_tests.py`)
...
> **Canonical figures (verified 2026-09-10).** Main branch: 635 test IDs across
> 47 test-bearing modules in `protocol_tests/` (files with no `test_id` — CLI,
...
> This table lists the largest modules; the full harness spans **47 test-bearing
> modules / 635 tests** on `main` (verified 2026-09-10 via `scripts/count_tests.py`).
