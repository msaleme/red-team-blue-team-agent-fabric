...
**606 security tests across 43 test-bearing modules** on `main` (verified 2026-08-11 by `scripts/count_tests.py`)
...
> **Canonical figures (verified 2026-08-11).** Main branch: 606 test IDs across
...
> `pyproject.toml` is at `agent-security-harness` v4.15.0 (606 tests); PyPI
...
> modules / 606 tests** on `main` (verified 2026-08-11 via `scripts/count_tests.py`).
