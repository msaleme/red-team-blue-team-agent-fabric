...
**627 security tests across 45 test-bearing modules** on `main` (verified 2026-09-10 by `scripts/count_tests.py`)
...
> **Canonical figures (verified 2026-09-10).** Main branch: 627 test IDs across
...
> modules / 627 tests** on `main` (verified 2026-09-10 via `scripts/count_tests.py`).
