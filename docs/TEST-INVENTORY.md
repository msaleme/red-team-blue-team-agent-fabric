...
**541 security tests across 37 modules** (verified 2026-07-12 by `scripts/count_tests.py`)

> **Canonical figures (verified 2026-07-12).** Package `agent-security-harness`
> v4.9.1. 541 test IDs across 37 test-bearing modules in `protocol_tests/`
...
> modules / 541 tests** (verified 2026-07-12 via `scripts/count_tests.py`).
