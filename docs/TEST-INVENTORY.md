...
**640 security tests across 48 test-bearing modules** on `main` (verified 2026-09-21 by `scripts/count_tests.py`)
...
> **Canonical figures (verified 2026-09-10).** Main branch: 640 test IDs across
> 48 test-bearing modules in `protocol_tests/` (files with no `test_id` — CLI,
...
> This table lists the largest modules; the full harness spans **48 test-bearing
> modules / 640 tests** on `main` (verified 2026-09-21 via `scripts/count_tests.py`).
