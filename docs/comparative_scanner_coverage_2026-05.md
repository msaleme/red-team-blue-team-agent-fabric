...
The second-hardest cell was the NIST row. There is no canonical "NIST AI 800-2" publication number as of 2026-05-24; the closest is the **NCCoE Concept Paper, 2026-02-05**, "Accelerating the Adoption of Software and AI Agent Identity and Authorization," which is in initial public draft and requests community feedback on identity, authorization, auditing, non-repudiation, and prompt-injection mitigations. The matrix cites that paper and the umbrella NIST AI Agent Standards Initiative page. Before publish, the citation should read "NIST NCCoE concept paper (IPD, Feb 2026)" rather than "NIST AI 800-2."
