...
635 tests. 47 test-bearing modules. 7 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 635-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 635 executable tests across 47 test-bearing modules
