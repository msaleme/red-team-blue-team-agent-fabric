...
640 tests. 48 test-bearing modules. 7 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 640-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 640 executable tests across 48 test-bearing modules
