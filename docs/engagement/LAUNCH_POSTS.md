...
603 tests. 44 modules. 7 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 603-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 603 executable tests across 44 modules
