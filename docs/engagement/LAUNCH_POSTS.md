...
595 tests. 43 modules. 5 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 595-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 595 executable tests across 43 modules
