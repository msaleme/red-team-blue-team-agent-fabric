...
631 tests. 46 test-bearing modules. 7 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 631-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 631 executable tests across 46 test-bearing modules
