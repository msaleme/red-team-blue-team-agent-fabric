...
541 tests. 37 modules. 5 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 541-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 541 executable tests across 37 modules
