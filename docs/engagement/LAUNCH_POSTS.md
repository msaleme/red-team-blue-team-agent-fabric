...
608 tests. 43 test-bearing modules. 7 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 608-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 608 executable tests across 43 test-bearing modules
