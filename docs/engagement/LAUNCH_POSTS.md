...
627 tests. 45 test-bearing modules. 7 public Zenodo preprints (not peer-reviewed). Apache 2.0.
...
**Title:** Show HN: 627-test adversarial harness for AI agents (MCP, A2A, x402/L402)
...
- 627 executable tests across 45 test-bearing modules
