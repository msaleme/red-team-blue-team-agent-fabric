...
The harness spans 47 test-bearing modules. A representative subset (protocol
...
**Total: 635 security tests across 47 test-bearing modules** (verified 2026-09-10 via `scripts/count_tests.py`)
