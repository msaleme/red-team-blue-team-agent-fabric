...
def build_recommendation(results: list[dict], grade: str) -> str:
    ...
    if not failed:
        return (
            ...
            "(608 tests across 43 test-bearing modules including DoS resilience, sampling hijack, and path traversal) "
...
def format_markdown(report: dict) -> str:
    ...
    lines.extend([
        ...
        f"*Run the full harness for 608 tests across 43 test-bearing modules including DoS, sampling hijack, path traversal, and more.*",
    ])
