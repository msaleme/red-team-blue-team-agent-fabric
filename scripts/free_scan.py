...
def build_recommendation(results: list[dict], grade: str | None) -> str:
    ...
    if not failed:
        return (
            ...
            "(627 tests across 45 test-bearing modules including DoS resilience, sampling hijack, and path traversal) "
...
def format_markdown(report: dict) -> str:
    ...
    lines.extend([
        ...
        "*Run the full harness for 627 tests across 45 test-bearing modules including DoS, sampling hijack, path traversal, and more.*",
    ])
