...
| **Cost control** | Each test completes in <15 seconds. Full 635-test suite runs in <30 minutes. No GPU or expensive inference required. |
...
_Canonical count at the revision this document was last updated: 635 tests (`python scripts/count_tests.py`)._
