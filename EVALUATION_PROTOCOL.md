...
| **Cost control** | Each test completes in <15 seconds. Full 611-test suite runs in <30 minutes. No GPU or expensive inference required. |
...
_Framework version: 4.16.0 (611 tests)_
