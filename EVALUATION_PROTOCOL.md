...
| **Cost control** | Each test completes in <15 seconds. Full 604-test suite runs in <30 minutes. No GPU or expensive inference required. |
...
_Framework version: 4.15.0 (604 tests)_
