...
**Generated:** `scripts/generate_test_catalog.py` at commit `51a127a`
**Test count:** 603 unique test IDs across 44 registered harness modules (43 contain test IDs; `community_runner.py` is a plugin runner with none of its own)
...
```
CHAIN-001 | Credential → Identity → Cloud Pivot (3-Step Chain) | protocol_tests/advanced_attacks.py:390
CHAIN-002 | SaaS Lateral Movement (Doc → Email → Finance) | protocol_tests/advanced_attacks.py:431
JAIL-001 | Jailbreak Persistence (Same Session + Cross-Session) | protocol_tests/advanced_attacks.py:528
JAIL-002 | Roleplay-Based Jailbreak (4 Personas) | protocol_tests/advanced_attacks.py:576
POLY-001 | Polymorphic Injection (10 Unique Payloads) | protocol_tests/advanced_attacks.py:139
POLY-002 | Encoding Evasion (8 Variants) | protocol_tests/advanced_attacks.py:186
RECON-001 | Attack Surface Self-Mapping (5 Queries) | protocol_tests/advanced_attacks.py:474
STATE-001 | Trust-Building → Escalation (8 turns) | protocol_tests/advanced_attacks.py:241
STATE-002 | Playbook Injection Bypass (Mexico Breach Pattern) | protocol_tests/advanced_attacks.py:301
STATE-003 | Guardrail Erosion (8-Step Progressive Escalation) | protocol_tests/advanced_attacks.py:341
```
...
```
AQ-001 | Data Source Boundary Escape (S3 + Confluence) | protocol_tests/enterprise_adapters.py:422
AQ-002 | IAM Role Escalation | protocol_tests/enterprise_adapters.py:439
AQ-003 | Destructive Action Execution | protocol_tests/enterprise_adapters.py:457
ENT-OR-001 | Supplier Bank Detail Exfiltration | protocol_tests/enterprise_adapters.py:677
ENT-OR-002 | Approval Workflow Bypass (Purchase Orders) | protocol_tests/enterprise_adapters.py:695
ENT-OR-003 | SQL Injection via Agent | protocol_tests/enterprise_adapters.py:715
GC-001 | Agent Injection (BigQuery + Drive) | protocol_tests/enterprise_adapters.py:348
GC-002 | Data Store Grounding Poisoning | protocol_tests/enterprise_adapters.py:365
GC-003 | Workspace Action Boundary (Email Exfil) | protocol_tests/enterprise_adapters.py:384
MS-001 | Copilot Prompt Injection (Dataverse + Power Automate) | protocol_tests/enterprise_adapters.py:258
MS-002 | Plugin/Connector Permission Escape | protocol_tests/enterprise_adapters.py:276
MS-003 | Cross-Tenant Data Access | protocol_tests/enterprise_adapters.py:293
MS-004 | Graph API Scope Escalation | protocol_tests/enterprise_adapters.py:311
OC-001 | Session Message Injection | protocol_tests/enterprise_adapters.py:167
OC-002 | Cross-Session History Access | protocol_tests/enterprise_adapters.py:183
OC-003 | Elevated Tool Execution Escape | protocol_tests/enterprise_adapters.py:200
OC-004 | Cron Job Injection | protocol_tests/enterprise_adapters.py:219
SAP-001 | Financial Posting Injection (Vendor Invoice) | protocol_tests/enterprise_adapters.py:586
SAP-002 | Safety Procedure Override (Plant Maintenance) | protocol_tests/enterprise_adapters.py:606
SAP-003 | Cross-Company Code Data Access | protocol_tests/enterprise_adapters.py:622
SAP-004 | SCADA Setpoint Manipulation via Agent | protocol_tests/enterprise_adapters.py:640
SF-001 | Cross-Object Data Access (Opportunities + Contacts) | protocol_tests/enterprise_adapters.py:752
SF-002 | Destructive Flow Trigger via Agent | protocol_tests/enterprise_adapters.py:770
SF-003 | MuleSoft API Policy Bypass | protocol_tests/enterprise_adapters.py:786
SN-001 | CMDB Data Exfiltration (Server Inventory) | protocol_tests/enterprise_adapters.py:822
SN-002 | Change Management Bypass (Emergency Change) | protocol_tests/enterprise_adapters.py:841
SN-003 | Mass Incident Escalation Manipulation | protocol_tests/enterprise_adapters.py:860
WD-001 | PII Exfiltration via HCM Agent | protocol_tests/enterprise_adapters.py:494
WD-002 | Payroll Modification via Social Engineering | protocol_tests/enterprise_adapters.py:513
WD-003 | Cross-Employee Data Access (CEO Compensation) | protocol_tests/enterprise_adapters.py:529
WD-004 | Mass Benefits Enrollment Manipulation | protocol_tests/enterprise_adapters.py:547
```

### Enterprise Platforms (extended) (`protocol_tests/extended_enterprise_adapters.py`) — 27 tests

```
AP-001 | KYC Process Rule Override | protocol_tests/extended_enterprise_adapters.py:698
AP-002 | Record-Level Security Bypass | protocol_tests/extended_enterprise_adapters.py:712
AT-001 | Cross-Project Data Access (Security + HR) | protocol_tests/extended_enterprise_adapters.py:449
AT-002 | Confluence Knowledge Base Poisoning | protocol_tests/extended_enterprise_adapters.py:465
DB-001 | Unity Catalog Permission Bypass | protocol_tests/extended_enterprise_adapters.py:280
DB-002 | Notebook Code Execution Escape | protocol_tests/extended_enterprise_adapters.py:297
DB-003 | MLflow Model Registry Poisoning | protocol_tests/extended_enterprise_adapters.py:315
HS-001 | Contact PII Export (Including DNC) | protocol_tests/extended_enterprise_adapters.py:652
HS-002 | Mass Phishing Email via Agent | protocol_tests/extended_enterprise_adapters.py:668
IF-001 | MRO Approved Supplier Override | protocol_tests/extended_enterprise_adapters.py:545
IF-002 | Field Service Safety Permit Bypass | protocol_tests/extended_enterprise_adapters.py:562
IF-003 | Safety Budget Reallocation | protocol_tests/extended_enterprise_adapters.py:579
IN-001 | Multi-Tenant Cross-Company Access | protocol_tests/extended_enterprise_adapters.py:608
IN-002 | Supply Chain Address Redirect | protocol_tests/extended_enterprise_adapters.py:624
MX-001 | Mass Work Order Close (Skip Safety Inspection) | protocol_tests/extended_enterprise_adapters.py:132
MX-002 | Asset Data Bulk Export | protocol_tests/extended_enterprise_adapters.py:146
MX-003 | IoT Sensor Threshold Manipulation (Pump Vibration) | protocol_tests/extended_enterprise_adapters.py:162
MX-004 | Predictive Maintenance Alert Override | protocol_tests/extended_enterprise_adapters.py:180
PG-001 | Mass Claim Approval (Skip Fraud Detection) | protocol_tests/extended_enterprise_adapters.py:351
PG-002 | Decision Strategy Override (Credit Risk) | protocol_tests/extended_enterprise_adapters.py:367
SC-001 | SQL Injection via Cortex Analyst | protocol_tests/extended_enterprise_adapters.py:216
SC-002 | Cross-Database Boundary Escape | protocol_tests/extended_enterprise_adapters.py:230
SC-003 | Data Share Exfiltration to External Account | protocol_tests/extended_enterprise_adapters.py:246
UI-001 | Robot Credential Asset Exfiltration | protocol_tests/extended_enterprise_adapters.py:400
UI-002 | Process Execution with Injected Connection | protocol_tests/extended_enterprise_adapters.py:416
ZD-001 | Customer PII Bulk Exfiltration | protocol_tests/extended_enterprise_adapters.py:493
ZD-002 | Mass Ticket Closure (Competitor Sabotage) | protocol_tests/extended_enterprise_adapters.py:509
```
...
```
AUDIT-001 | Action Audit Trail Availability | protocol_tests/identity_harness.py:536
AUDIT-002 | Action Non-Repudiation (Attribution in Response) | protocol_tests/identity_harness.py:568
AUTH-001 | Unauthenticated Access Prevention | protocol_tests/identity_harness.py:242
AUTH-002 | Expired/Revoked Credential Rejection | protocol_tests/identity_harness.py:280
AUTH-003 | OAuth Token Scope Escalation | protocol_tests/identity_harness.py:327
AUTHZ-001 | Least Privilege Enforcement | protocol_tests/identity_harness.py:380
AUTHZ-002 | Delegation Chain Validation ( | protocol_tests/identity_harness.py:420
AUTHZ-003 | Human-in-the-Loop Approval Forgery | protocol_tests/identity_harness.py:452
AUTHZ-004 | Zero-Trust Re-Authorization on Context Change | protocol_tests/identity_harness.py:497
DATA-001 | Cross-Source Data Aggregation Sensitivity | protocol_tests/identity_harness.py:599
DATA-002 | Prompt Provenance / Injection via Context | protocol_tests/identity_harness.py:634
DATA-003 | Output Data Sensitivity Classification | protocol_tests/identity_harness.py:665
ID-001 | Agent Identity Metadata Availability | protocol_tests/identity_harness.py:129
ID-002 | Agent Identity Spoofing Resistance | protocol_tests/identity_harness.py:172
ID-003 | Ephemeral Identity Isolation (Cross-Session) | protocol_tests/identity_harness.py:211
STD-001 | OAuth 2.1 / OIDC Discovery Endpoints | protocol_tests/identity_harness.py:700
STD-002 | SPIFFE Workload Identity Support | protocol_tests/identity_harness.py:723
STD-003 | SCIM Agent Lifecycle Management | protocol_tests/identity_harness.py:753
```
...
```
INT-001 | Intent Declaration Completeness | protocol_tests/intent_contract_harness.py:202
INT-002 | Intent-Action Consistency | protocol_tests/intent_contract_harness.py:242
INT-003 | Intent Scope Violation | protocol_tests/intent_contract_harness.py:277
INT-004 | Intent Modification Mid-Execution | protocol_tests/intent_contract_harness.py:318
INT-005 | Implicit Intent Escalation | protocol_tests/intent_contract_harness.py:366
INT-006 | Intent Contract Forgery | protocol_tests/intent_contract_harness.py:407
INT-007 | Multi-Step Intent Decomposition Attack | protocol_tests/intent_contract_harness.py:454
INT-008 | Intent Ambiguity Exploitation | protocol_tests/intent_contract_harness.py:491
```
...
```
MEM-001 | Cross-Session Context Leakage | protocol_tests/memory_harness.py:250
MEM-002 | Memory Poisoning via Tool Output | protocol_tests/memory_harness.py:285
MEM-003 | Context Window Overflow | protocol_tests/memory_harness.py:321
MEM-004 | Conversation History Manipulation | protocol_tests/memory_harness.py:352
MEM-005 | RAG Store Poisoning | protocol_tests/memory_harness.py:386
MEM-006 | Memory-Based Privilege Escalation | protocol_tests/memory_harness.py:427
MEM-007 | Selective Memory Erasure | protocol_tests/memory_harness.py:459
MEM-008 | Cross-User Memory Contamination | protocol_tests/memory_harness.py:499
MEM-009 | Temporal Consistency Attack | protocol_tests/memory_harness.py:538
MEM-010 | Memory Extraction via Indirect Prompting | protocol_tests/memory_harness.py:581
```

### Multi-Agent Interaction (`protocol_tests/multi_agent_harness.py`) — 18 tests

```
MAG-001 | Delegation Chain Poisoning | protocol_tests/multi_agent_harness.py:273
MAG-002 | Authority Impersonation in Multi-Agent Handoff | protocol_tests/multi_agent_harness.py:315
MAG-003 | Consensus Manipulation in Multi-Agent Decision | protocol_tests/multi_agent_harness.py:351
MAG-004 | Task Result Poisoning from Downstream Agent | protocol_tests/multi_agent_harness.py:394
MAG-005 | Cross-Agent Privilege Escalation | protocol_tests/multi_agent_harness.py:444
MAG-006 | Agent Collusion Detection | protocol_tests/multi_agent_harness.py:479
MAG-007 | Orchestrator Trust Boundary Bypass | protocol_tests/multi_agent_harness.py:523
MAG-008 | Recursive Delegation Attack | protocol_tests/multi_agent_harness.py:560
MAG-009 | Capability Leakage Across Agent Boundaries | protocol_tests/multi_agent_harness.py:606
MAG-010 | Shared Context Contamination | protocol_tests/multi_agent_harness.py:654
MAG-011 | Split-Brain Decision Making | protocol_tests/multi_agent_harness.py:692
MAG-012 | Agent Replacement/Substitution Attack | protocol_tests/multi_agent_harness.py:737
MAG-013 | Message-Ordering Race Pretext | protocol_tests/multi_agent_harness.py:779
MAG-014 | Recipient-Validation TOCTOU Pretext | protocol_tests/multi_agent_harness.py:822
MAG-015 | Event-Signal Collision Pretext | protocol_tests/multi_agent_harness.py:865
MAG-016 | Kill-vs-Complete Race Pretext | protocol_tests/multi_agent_harness.py:910
MAG-017 | Stale-Status-After-Timeout Pretext | protocol_tests/multi_agent_harness.py:956
MAG-018 | Inbox-Append-to-Last-Call-Only Pretext | protocol_tests/multi_agent_harness.py:1001
```
